...
* ``“ GET /Consents/Consent/{id} ”`` API on the HDAF. The HDAF must validate the HIU/HDAF client and only respond with consent artefact that corresponds tothese entities.
