...
import in.projecteka.hdaf.link.discovery.repository.DiscoveryRepository;
...
import static in.projecteka.hdaf.link.TestBuilders.discoveryResponse;
import static in.projecteka.hdaf.link.TestBuilders.identifier;
import static in.projecteka.hdaf.link.TestBuilders.patientIdentifier;
import static in.projecteka.hdaf.link.TestBuilders.patientInResponse;
import static in.projecteka.hdaf.link.TestBuilders.patientRequest;
import static in.projecteka.hdaf.link.TestBuilders.patientResponse;
import static in.projecteka.hdaf.link.TestBuilders.provider;
import static in.projecteka.hdaf.link.TestBuilders.providerIdentifier;
...
public class DiscoveryTest {
    ...
    public void returnProvidersWithOfficial() {
        ...
        var identifier = identifier().use(in.projecteka.hdaf.link.discovery.model.Identifier.IdentifierType.OFFICIAL.toString()).build();
    ...
    public void patientForGivenProviderIdAndPatientId() {
        ...
        in.projecteka.hdaf.link.discovery.model.patient.response.Patient patientInResponse = patientInResponse()
                .display("John Doe")
                .referenceNumber("123")
                .matchedBy(of())
                .careContexts(of())
